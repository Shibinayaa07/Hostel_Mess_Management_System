<?php
// Suppress all warnings and notices to prevent output before PDF generation
...
class MYPDF extends TCPDF {
    public function Header() {
        ...
        $leftLogoFiles = [
            ['path' => 'image/icons/mkce_logo.jpg', 'type' => 'JPG'],
            ['path' => 'image/icons/mkce_s.png', 'type' => 'PNG'],
            ['path' => 'image/icons/mkce_s.jpg', 'type' => 'JPG']
        ];
        ...
        // Right logo - kr.jpg
        $rightLogoFiles = [
            ['path' => 'image/kr.jpg', 'type' => 'JPG'],
            ['path' => 'image/kr.png', 'type' => 'PNG']
        ];
        ...
        if ($leftLogo !== null) {
            try {
                @$this->Image($leftLogo['path'], 10, 8, 20, 20, $leftLogo['type'], '', 'T', false, 300, '', false, false, 0, false, false, false);
            } catch (Exception $e) {
        ...
        if ($rightLogo !== null) {
            try {
                @$this->Image($rightLogo['path'], 185, 8, 15, 18, $rightLogo['type'], '', 'T', false, 300, '', false, false, 0, false, false, false);
            } catch (Exception $e) {
                // If image fails, continue without logo
            }
        }
        ...
        $this->Cell(130, 6, $collegeName, 0, 1, 'C', 0, '', 0, false, 'M', 'M');
        
        // Add space between college name and subtitle
        $this->Ln(2);
        
        // Subtitle - centered
        $this->SetFont('helvetica', 'I', 8);
        $this->SetX(40);
        $this->Cell(130, 5, $subTitle, 0, 1, 'C', 0, '', 0, false, 'M', 'M');
